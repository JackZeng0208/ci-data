...
*Generated: Jun 06 | Commit: `b3e4c20`*

> [!WARNING]
> **Performance Regression Detected**
>
> - **ltx2_twostage_t2v** (sglang): 7.56s -> 8.46s (+11.9%)
> - **ltx2.3_twostage_ti2v_2gpus** (sglang): 17.06s -> 31.11s (+82.3%)
...
| Z-Image-Turbo | ✅ | **0.92** |
| Wan2.2-T2V-A14B-Diffusers | ✅ | **212.35** |
...
> - ltx2_twostage_t2v: SGLang regression +11.8% vs 3-run avg (8.46s vs 7.56s)
> - ltx2.3_twostage_ti2v_2gpus: SGLang regression +66.0% vs 3-run avg (31.11s vs 18.74s)
