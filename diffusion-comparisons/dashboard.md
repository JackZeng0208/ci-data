...
*Generated: Jun 18 | Commit: `74e2e48`*

> [!WARNING]
> **Performance Regression Detected**
>
> - **ltx2.3_twostage_ti2v_2gpus** (sglang): 20.08s -> 24.08s (+19.9%)
...
| FLUX.1-dev | ✅ | **6.93** |
| FLUX.2-dev | ✅ | **24.48** |
| Qwen-Image-2512 | ✅ | **12.71** |
| Qwen-Image-Edit-2511 | ✅ | **23.57** |
| Z-Image-Turbo | ✅ | **0.92** |
| Wan2.2-T2V-A14B-Diffusers | ✅ | **209.03** |
...
| May 22 | `ff700aa` | 6.62 | 22.60 | 12.77 | 23.95 | 0.93 | 215.70 | 59.19 | 8.49 | N/A | 211.59 | -- |
