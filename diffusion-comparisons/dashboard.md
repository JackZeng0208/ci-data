...
*Generated: May 30 | Commit: `c2ac37d`*

> [!WARNING]
> **Performance Regression Detected**
>
> - **ltx2_twostage_t2v** (sglang): 7.56s -> 8.47s (+12.1%)
> - **ltx2.3_twostage_ti2v_2gpus** (sglang): 20.07s -> 28.11s (+40.0%)
...
| FLUX.1-dev | ✅ | **7.13** |
| FLUX.2-dev | ✅ | **24.65** |
| Qwen-Image-2512 | ✅ | **12.84** |
| Qwen-Image-Edit-2511 | ✅ | **23.80** |
| Z-Image-Turbo | ✅ | **0.92** |
| Wan2.2-T2V-A14B-Diffusers | ✅ | **212.39** |
| Wan2.2-TI2V-5B-Diffusers | ✅ | **65.24** |
| LTX-2 | ⚠️ | **8.47** |
| LTX-2.3 | ⚠️ | **28.11** |
| Wan2.2-I2V-A14B-Diffusers | ✅ | **208.66** |
...
> - ltx2_twostage_t2v: SGLang regression +12.2% vs 3-run avg (8.47s vs 7.55s)
> - ltx2.3_twostage_ti2v_2gpus: SGLang regression +44.9% vs 3-run avg (28.11s vs 19.40s)
