...
*Generated: May 18 | Commit: `b380316`*

> [!WARNING]
> **Performance Regression Detected**
>
> - **ltx2.3_twostage_ti2v_2gpus** (sglang): 19.07s -> 25.08s (+31.6%)
...
| Z-Image-Turbo | ✅ | **0.89** |
| Wan2.2-T2V-A14B-Diffusers | ✅ | **215.85** |
| Wan2.2-TI2V-5B-Diffusers | ✅ | **58.15** |
| LTX-2 | ✅ | **8.58** |
| LTX-2.3 | ⚠️ | **25.08** |
| Wan2.2-I2V-A14B-Diffusers | ✅ | **211.55** |
...
> - ltx2.3_twostage_ti2v_2gpus: SGLang regression +31.6% vs 3-run avg (25.08s vs 19.07s)
