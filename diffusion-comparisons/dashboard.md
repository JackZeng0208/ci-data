...
*Generated: Jun 19 | Commit: `05ee93c`*

> [!WARNING]
> **Performance Regression Detected**
>
> - **ltx2_twostage_t2v** (sglang): 7.70s -> 8.36s (+8.6%)
...
| Z-Image-Turbo | ✅ | **0.91** |
| Wan2.2-T2V-A14B-Diffusers | ✅ | **209.14** |
| Wan2.2-TI2V-5B-Diffusers | ✅ | **65.23** |
| LTX-2 | ⚠️ | **8.36** |
| LTX-2.3 | ✅ | **15.06** |
| Wan2.2-I2V-A14B-Diffusers | ✅ | **204.65** |
...
| May 22 | `ff700aa` | 6.68 | 22.77 | 12.89 | 24.13 | 0.94 | 216.10 | 59.18 | 8.57 | N/A | 212.54 | -- |

> [!CAUTION]
> **Action Required — Performance Alert**
>
> The following cases need attention:
> - ltx2_twostage_t2v: SGLang regression +8.3% vs 3-run avg (8.36s vs 7.72s)
