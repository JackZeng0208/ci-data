...
*Generated: May 28 | Commit: `421bda6`*

> [!WARNING]
> **Performance Regression Detected**
>
> - **ltx2.3_twostage_ti2v_2gpus** (sglang): 17.06s -> 21.08s (+23.5%)
...
| Z-Image-Turbo | ✅ | **0.91** |
| Wan2.2-T2V-A14B-Diffusers | ✅ | **212.60** |
...
> - ltx2.3_twostage_ti2v_2gpus: SGLang regression +12.5% vs 3-run avg (21.08s vs 18.73s)
